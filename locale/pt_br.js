  ...
  workExperience: {
    ...
    experiences: [
      ...
      },
      {
        ...
        <p>No projeto Infohidro, participei do desenvolvimento de uma plataforma de monitoramento hidrológico, que permitia o acesso a dados e informações sobre os níveis de rios, chuvas e outras variáveis hidrológicas. Utilizei Vue.js para construir a interface do usuário, proporcionando uma experiência intuitiva e eficiente para os usuários explorarem e interpretarem os dados hidrológicos de forma visualmente atraente.</p></br>    
        <p>No projeto Stormboard, fui responsável por desenvolver uma aplicação web interativa para visualização de informações meteorológicas em tempo real. Criei uma interface dinâmica e responsiva, que permitia aos usuários acompanhar os padrões climáticos, visualizar previsões e receber alertas de tempestades com base nos dados fornecidos pelo Simepar.</p></br>
      ...
      },
      {
        ...
        <p>No projeto AdmRH, concentrei-me na criação de recursos de gestão de Recursos Humanos. Desenvolvi módulos para gerenciamento de funcionários. Utilizei Vue.js para criar interfaces responsivas e amigáveis, permitindo que os usuários gerenciassem efetivamente os processos de RH.</p></br>
        <p>Durante minha experiência na CGI, também participei de atividades como testes, correções de bugs e documentação dos sistemas desenvolvidos. Colaborei em equipe, seguindo boas práticas de desenvolvimento ágil e trabalhando em estreita colaboração com os demais membros da equipe.</p></br>
        <p>Essa experiência me permitiu aprimorar minhas habilidades bem como minha compreensão de desenvolvimento de software, arquitetura de aplicativos web e boas práticas de codificação. Adquiri conhecimento em desenvolvimento de sistemas empresariais e soluções de gestão, ganhando uma visão mais ampla das necessidades e desafios enfrentados pelas empresas.</p></br>
        `,
      },
      {
        period: "2018 - 2020",
        ...
        <p>Preencher fichas técnicas da obra, detalhando todas as informações relevantes para o projeto;</p></br>
        <p>Desenvolver modelos 3D das obras com base nas informações recebidas, seguindo os padrões e requisitos estabelecidos pelos clientes e cumprindo os critérios internos de qualidade da empresa;</p></br>
        <p>Executar o checklist 3D, verificando minuciosamente cada etapa do projeto para garantir sua conformidade;</p></br>
        <p>Enviar o modelo aos setores de desenho 2D, fornecendo orientações e direcionamentos para a conclusão da obra;</p></br>
        <p>Acompanhar a elaboração dos diagramas de montagem, assegurando a inclusão de todas as informações necessárias e alinhadas com as exigências do cliente;</p></br>
        <p>Controlar e organizar todas as informações técnicas referentes à obra em processo de modelagem, garantindo a disponibilidade dos dados necessários durante todo o ciclo do projeto;</p></br>
        <p>Controlar o escopo de fornecimento de cada obra, assegurando que todas as entregas estejam completamente atendidas;</p></br>
        <p>Desempenhar a responsabilidade de manter um arquivo histórico do projeto, documentando todas as etapas e alterações realizadas;</p></br>
        <p>Essas atividades exigiram atenção aos detalhes, habilidades técnicas avançadas em ferramentas como AutoCAD e Tecnometal, e a capacidade de trabalhar em equipe, coordenando os setores envolvidos e garantindo a excelência e qualidade dos projetos. Minha dedicação em seguir os padrões de qualidade, bem como a organização e controle efetivo das informações técnicas, contribuíram para o sucesso dos projetos de obras em estrutura metálica nos quais estive envolvido.</p></br>
        `,
      },
      {
        period: "2010 - 2018",
